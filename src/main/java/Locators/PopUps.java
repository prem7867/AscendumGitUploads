...
public class PopUps {
    ...
    public By content = By.id("android:id/content");
    public By scrollView = By.xpath("//android.widget.ScrollView");
    public By grantSingleton = By.id("com.android.permissioncontroller:id/grant_singleton");
    public By grantDialog = By.id("com.android.permissioncontroller:id/grant_dialog");
}