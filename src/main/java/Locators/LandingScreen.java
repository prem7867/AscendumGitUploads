...
public class LandingScreen {
    ...
    public By bluetoothDevicesList = By.xpath("//android.view.View[contains(@content-desc, '" + bleName + "')]");
   ...
   public By logout = By.xpath("//android.view.View[@content-desc='Logout']");
    public By bluetoothIconName = By.xpath("//android.view.View[@content-desc='"+bleName+"']");
