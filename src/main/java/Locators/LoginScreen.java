...
public class LoginScreen {
   ...
   // public By signInText = By.xpath("//android.widget.Button[@text=\'submit\']");
    ...
    //android.widget.TextView[@text="Forgot your password?"]
    ...
    public By betBridgeConfigIcon = By.xpath("//android.view.View[@content-desc=\'Version  1.0.34 \']/android.widget.ImageView[1]");
    public By cpiLogo = By.xpath("//android.view.View[@content-desc=\'Version  1.0.34 \']/android.widget.ImageView[3]");
    ...
    public By refreshIcon = By.xpath("//android.view.View[@content-desc=\'Version  1.0.34 \']/android.widget.ImageView[2]");
    ...
    public By noNetworkRefreshIcon = By.xpath("//android.view.View[@content-desc='Version  1.0.31 \n" +
