...
public class LandingDetailsPage extends TestBase {
        ...
        public void clickAvailableBLE() {
                WebDriverWait wait = new WebDriverWait(appiumDriver, Duration.ofSeconds(5000));
                wait.until(ExpectedConditions.visibilityOf(appiumDriver.findElement(landingScreen.bluetoothDevicesList)));
                baseActions.click(landingScreen.bluetoothDevicesList);
        }
}